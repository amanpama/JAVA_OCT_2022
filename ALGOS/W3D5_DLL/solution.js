...
class DLList {
    ...
    isPalindrome() {
        ...
        var reverseRunner = this.tail;
        // checks if data of runners is equal
        while (forwardRunner.data == reverseRunner.data) {
            forwardRunner = forwardRunner.next;
            reverseRunner = reverseRunner.prev;
            if (forwardRunner.data == null && reverseRunner.data == null) {
                return true;
            }
        }
        if (forwardRunner != reverseRunner) {
            return false;
        }
    }
